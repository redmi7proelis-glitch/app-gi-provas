          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 dark:bg-yellow-400 text-white dark:text-gray-900 p-6 rounded-3xl flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 mt-auto">
                <button className="w-full bg-white/10 dark:bg-gray-900/10 hover:bg-white/20 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2">
                  <Plus size={18} /> Nova Avaliação
                </button>
                <button className="w-full bg-yellow-400 dark:bg-gray-900 text-gray-900 dark:text-yellow-400 hover:opacity-90 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2">
          ...
          <section className="mt-12">
            ...
            {assessments.length === 0 ? (
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {/* Listagem de avaliações viria aqui */}
               </div>
            )}
          </section>
        </main>
